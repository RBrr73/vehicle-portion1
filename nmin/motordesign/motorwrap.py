...
# This oottaDAO component contains an engine model found in Sitthiracha "AN
...
from oottadao.main.datatypes.api import Float, Int, Bool

from oottadao.examples.enginedesign.engineC import RunEngineCycle
