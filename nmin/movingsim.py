"""
  ...
  Contains oottaDAO drivers that can simulate different driving regimes
...
from oottadao.main.api import Driver, convert_units
from oottadao.main.datatypes.api import Float, Str
from oottadao.main.hasobjective import HasObjectives
from oottadao.main.hasparameters import HasParameters
from oottadao.main.interfaces import IHasParameters, IHasObjectives, \
                                     implements
from oottadao.util.decorators import add_delegate
...
class SimEconomy(Driver):
    ...
    def execute(self):
        ...
        profile_stream = resource_stream('oottadao.examples.enginedesign',
                                         self.profilename)
