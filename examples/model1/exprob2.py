...
from oottadao.lib.datatypes.api import Float
from oottadao.lib.drivers.api import CaseIteratorDriver
from oottadao.lib.components.api import MultiFiMetaModel
from oottadao.lib.surrogatemodels.api import MultiFiCoKrigingSurrogate, KrigingSurrogate
...
if __name__ == "__main__":
    ...
    plt.plot(check, predicted_cok, '2g', label='Co-kriging')
